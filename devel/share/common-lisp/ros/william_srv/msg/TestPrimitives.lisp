...
(cl:defmethod cl:initialize-instance :after ((m <TestPrimitives>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TestPrimitives)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name william_srv-msg:<TestPrimitives> is deprecated: use william_srv-msg:TestPrimitives instead.")))

(cl:ensure-generic-function 'caller_id-val :lambda-list '(m))
(cl:defmethod caller_id-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:caller_id-val is deprecated.  Use william_srv-msg:caller_id instead.")
  (caller_id m))

(cl:ensure-generic-function 'orig_caller_id-val :lambda-list '(m))
(cl:defmethod orig_caller_id-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:orig_caller_id-val is deprecated.  Use william_srv-msg:orig_caller_id instead.")
  (orig_caller_id m))

(cl:ensure-generic-function 'str-val :lambda-list '(m))
(cl:defmethod str-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:str-val is deprecated.  Use william_srv-msg:str instead.")
  (str m))
...
(cl:defmethod int16-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:int16-val is deprecated.  Use william_srv-msg:int16 instead.")
  (int16 m))

(cl:ensure-generic-function 'int32-val :lambda-list '(m))
(cl:defmethod int32-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:int32-val is deprecated.  Use william_srv-msg:int32 instead.")
  (int32 m))

(cl:ensure-generic-function 'int64-val :lambda-list '(m))
(cl:defmethod int64-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:int64-val is deprecated.  Use william_srv-msg:int64 instead.")
  (int64 m))

(cl:ensure-generic-function 'c-val :lambda-list '(m))
(cl:defmethod c-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:c-val is deprecated.  Use william_srv-msg:c instead.")
  (c m))

(cl:ensure-generic-function 'uint16-val :lambda-list '(m))
(cl:defmethod uint16-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:uint16-val is deprecated.  Use william_srv-msg:uint16 instead.")
  (uint16 m))

(cl:ensure-generic-function 'uint32-val :lambda-list '(m))
(cl:defmethod uint32-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:uint32-val is deprecated.  Use william_srv-msg:uint32 instead.")
  (uint32 m))

(cl:ensure-generic-function 'uint64-val :lambda-list '(m))
(cl:defmethod uint64-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:uint64-val is deprecated.  Use william_srv-msg:uint64 instead.")
  (uint64 m))

(cl:ensure-generic-function 'float32-val :lambda-list '(m))
(cl:defmethod float32-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:float32-val is deprecated.  Use william_srv-msg:float32 instead.")
  (float32 m))

(cl:ensure-generic-function 'float64-val :lambda-list '(m))
(cl:defmethod float64-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:float64-val is deprecated.  Use william_srv-msg:float64 instead.")
  (float64 m))

(cl:ensure-generic-function 't-val :lambda-list '(m))
(cl:defmethod t-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:t-val is deprecated.  Use william_srv-msg:t instead.")
  (t m))

(cl:ensure-generic-function 'd-val :lambda-list '(m))
(cl:defmethod d-val ((m <TestPrimitives>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:d-val is deprecated.  Use william_srv-msg:d instead.")
  (d m))
