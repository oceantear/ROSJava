...
(cl:defmethod cl:initialize-instance :after ((m <TestString>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TestString)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name william_srv-msg:<TestString> is deprecated: use william_srv-msg:TestString instead.")))
...
(cl:defmethod data-val ((m <TestString>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader william_srv-msg:data-val is deprecated.  Use william_srv-msg:data instead.")
  (data m))
