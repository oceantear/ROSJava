...
(cl:defmethod cl:initialize-instance :after ((m <TestHeader>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TestHeader)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jimmy_srv-msg:<TestHeader> is deprecated: use jimmy_srv-msg:TestHeader instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <TestHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jimmy_srv-msg:header-val is deprecated.  Use jimmy_srv-msg:header instead.")
  (header m))
...
(cl:defmethod auto_header-val ((m <TestHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jimmy_srv-msg:auto_header-val is deprecated.  Use jimmy_srv-msg:auto_header instead.")
  (auto_header m))
