...
(cl:defmethod cl:initialize-instance :after ((m <TestString>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TestString)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jimmy_srv-msg:<TestString> is deprecated: use jimmy_srv-msg:TestString instead.")))
