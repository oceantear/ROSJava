...
(cl:defclass <Composite> (roslisp-msg-protocol:ros-message)
  ((a
    :reader a
    :initarg :a
    :type jimmy_srv-msg:CompositeA
    :initform (cl:make-instance 'jimmy_srv-msg:CompositeA))
   (b
    :reader b
    :initarg :b
    :type jimmy_srv-msg:CompositeB
    :initform (cl:make-instance 'jimmy_srv-msg:CompositeB)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Composite>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Composite)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jimmy_srv-msg:<Composite> is deprecated: use jimmy_srv-msg:Composite instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <Composite>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jimmy_srv-msg:a-val is deprecated.  Use jimmy_srv-msg:a instead.")
  (a m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Composite>)))
  ...
  (cl:format cl:nil "# composite message. required for testing import calculation in generators~%CompositeA a~%CompositeB b~%~%================================================================================~%MSG: jimmy_srv/CompositeA~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: jimmy_srv/CompositeB~%# copy of geometry_msgs/Point for testing~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Composite)))
  "Returns full string definition for message of type 'Composite"
  (cl:format cl:nil "# composite message. required for testing import calculation in generators~%CompositeA a~%CompositeB b~%~%================================================================================~%MSG: jimmy_srv/CompositeA~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: jimmy_srv/CompositeB~%# copy of geometry_msgs/Point for testing~%float64 x~%float64 y~%float64 z~%~%~%"))
