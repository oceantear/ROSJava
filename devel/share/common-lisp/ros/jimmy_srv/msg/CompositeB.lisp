...
(cl:defmethod cl:initialize-instance :after ((m <CompositeB>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CompositeB)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jimmy_srv-msg:<CompositeB> is deprecated: use jimmy_srv-msg:CompositeB instead.")))
