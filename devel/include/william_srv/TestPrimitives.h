// Generated by gencpp from file william_srv/TestPrimitives.msg
// DO NOT EDIT!


#ifndef WILLIAM_SRV_MESSAGE_TESTPRIMITIVES_H
#define WILLIAM_SRV_MESSAGE_TESTPRIMITIVES_H
...
struct TestPrimitives_
{
  ...
  typedef boost::shared_ptr< ::william_srv::TestPrimitives_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::william_srv::TestPrimitives_<ContainerAllocator> const> ConstPtr;

}; // struct TestPrimitives_

typedef ::william_srv::TestPrimitives_<std::allocator<void> > TestPrimitives;

typedef boost::shared_ptr< ::william_srv::TestPrimitives > TestPrimitivesPtr;
typedef boost::shared_ptr< ::william_srv::TestPrimitives const> TestPrimitivesConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::william_srv::TestPrimitives_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::william_srv::TestPrimitives_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::william_srv::TestPrimitives_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::william_srv::TestPrimitives_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::william_srv::TestPrimitives_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::william_srv::TestPrimitives_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::william_srv::TestPrimitives_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::william_srv::TestPrimitives_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::william_srv::TestPrimitives_<ContainerAllocator> >
{
  ...
  static const char* value(const ::william_srv::TestPrimitives_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3e70f428a22c0d26ULL;
  static const uint64_t static_value2 = 0xca67f87802c8e00fULL;
};

template<class ContainerAllocator>
struct DataType< ::william_srv::TestPrimitives_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::william_srv::TestPrimitives_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::william_srv::TestPrimitives_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::william_srv::TestPrimitives_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::william_srv::TestPrimitives_<ContainerAllocator>& v)
  {
    s << indent << "caller_id: ";
...
#endif // WILLIAM_SRV_MESSAGE_TESTPRIMITIVES_H
