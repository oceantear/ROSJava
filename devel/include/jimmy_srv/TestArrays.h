// Generated by gencpp from file jimmy_srv/TestArrays.msg
// DO NOT EDIT!


#ifndef JIMMY_SRV_MESSAGE_TESTARRAYS_H
#define JIMMY_SRV_MESSAGE_TESTARRAYS_H
...
#include <jimmy_srv/TestString.h>
...
struct TestArrays_
{
  ...
  _time_array_type time_array;
   ...
   typedef std::vector< ::jimmy_srv::TestString_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::jimmy_srv::TestString_<ContainerAllocator> >::other >  _test_string_array_type;
  _test_string_array_type test_string_array;




  typedef boost::shared_ptr< ::jimmy_srv::TestArrays_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::jimmy_srv::TestArrays_<ContainerAllocator> const> ConstPtr;

}; // struct TestArrays_

typedef ::jimmy_srv::TestArrays_<std::allocator<void> > TestArrays;

typedef boost::shared_ptr< ::jimmy_srv::TestArrays > TestArraysPtr;
typedef boost::shared_ptr< ::jimmy_srv::TestArrays const> TestArraysConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::jimmy_srv::TestArrays_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::jimmy_srv::TestArrays_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::jimmy_srv::TestArrays_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::jimmy_srv::TestArrays_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::jimmy_srv::TestArrays_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::jimmy_srv::TestArrays_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::jimmy_srv::TestArrays_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::jimmy_srv::TestArrays_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::jimmy_srv::TestArrays_<ContainerAllocator> >
{
  ...
  static const char* value(const ::jimmy_srv::TestArrays_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4cc9b5e2cebe791aULL;
  static const uint64_t static_value2 = 0xa3e994f5bc159eb6ULL;
};

template<class ContainerAllocator>
struct DataType< ::jimmy_srv::TestArrays_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::jimmy_srv::TestArrays_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::jimmy_srv::TestArrays_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::jimmy_srv::TestArrays_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::jimmy_srv::TestArrays_<ContainerAllocator>& v)
  {
    s << indent << "caller_id: ";
    ...
    for (size_t i = 0; i < v.test_string_array.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::jimmy_srv::TestString_<ContainerAllocator> >::stream(s, indent + "    ", v.test_string_array[i]);
    }
  }
};
...
#endif // JIMMY_SRV_MESSAGE_TESTARRAYS_H
