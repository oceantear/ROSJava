// Generated by gencpp from file jimmy_srv/TestPrimitives.msg
// DO NOT EDIT!


#ifndef JIMMY_SRV_MESSAGE_TESTPRIMITIVES_H
#define JIMMY_SRV_MESSAGE_TESTPRIMITIVES_H
...
struct TestPrimitives_
{
  ...
  typedef boost::shared_ptr< ::jimmy_srv::TestPrimitives_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::jimmy_srv::TestPrimitives_<ContainerAllocator> const> ConstPtr;

}; // struct TestPrimitives_

typedef ::jimmy_srv::TestPrimitives_<std::allocator<void> > TestPrimitives;

typedef boost::shared_ptr< ::jimmy_srv::TestPrimitives > TestPrimitivesPtr;
typedef boost::shared_ptr< ::jimmy_srv::TestPrimitives const> TestPrimitivesConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::jimmy_srv::TestPrimitives_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::jimmy_srv::TestPrimitives_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::jimmy_srv::TestPrimitives_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::jimmy_srv::TestPrimitives_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::jimmy_srv::TestPrimitives_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::jimmy_srv::TestPrimitives_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::jimmy_srv::TestPrimitives_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::jimmy_srv::TestPrimitives_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::jimmy_srv::TestPrimitives_<ContainerAllocator> >
{
  ...
  static const char* value(const ::jimmy_srv::TestPrimitives_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3e70f428a22c0d26ULL;
  static const uint64_t static_value2 = 0xca67f87802c8e00fULL;
};

template<class ContainerAllocator>
struct DataType< ::jimmy_srv::TestPrimitives_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::jimmy_srv::TestPrimitives_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::jimmy_srv::TestPrimitives_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::jimmy_srv::TestPrimitives_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::jimmy_srv::TestPrimitives_<ContainerAllocator>& v)
  {
    s << indent << "caller_id: ";
...
#endif // JIMMY_SRV_MESSAGE_TESTPRIMITIVES_H
