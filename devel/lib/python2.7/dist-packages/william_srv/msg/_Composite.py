...
"""autogenerated by genpy from william_srv/Composite.msg. Do not edit."""
import sys
...
"""
  __slots__ = ['a','b']
  _slot_types = ['william_srv/CompositeA','william_srv/CompositeB']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.a is None:
        self.a = william_srv.msg.CompositeA()
      if self.b is None:
        self.b = william_srv.msg.CompositeB()
    else:
      self.a = william_srv.msg.CompositeA()
      self.b = william_srv.msg.CompositeB()
