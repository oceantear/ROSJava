...
"""autogenerated by genpy from william_srv/TestArrays.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import william_srv.msg
import genpy

class TestArrays(genpy.Message):
  _md5sum = "4cc9b5e2cebe791aa3e994f5bc159eb6"
  _type = "william_srv/TestArrays"
...
"""
  ...
  _slot_types = ['string','string','int32[]','float32[]','time[]','william_srv/TestString[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.test_string_array = []
      for i in range(0, length):
        val1 = william_srv.msg.TestString()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
