...
public interface TestArrays extends org.ros.internal.message.Message {
  static final java.lang.String _TYPE = "william_srv/TestArrays";
  ...
  java.util.List<william_srv.TestString> getTestStringArray();
  void setTestStringArray(java.util.List<william_srv.TestString> value);
}
